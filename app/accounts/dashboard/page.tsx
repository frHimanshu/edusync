      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center justify-between">
            ...
            <Button onClick={() => router.push("/accounts/profile")}>View Profile</Button>
          </div>
        </div>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <Button className="h-20 flex flex-col gap-2" onClick={() => router.push("/accounts/register-student")}>
              ...
              <Button
                ...
                onClick={() => router.push("/accounts/fees")}
              >
              ...
              <Button
                variant="outline"
                className="h-20 flex flex-col gap-2 bg-transparent"
                onClick={() => router.push("/accounts/students")}
              >
              ...
              <Button
                variant="outline"
                className="h-20 flex flex-col gap-2 bg-transparent"
                onClick={() => router.push("/accounts/id-cards")}
              >
