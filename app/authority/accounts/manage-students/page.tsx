...
import { Search, Users, Eye, Edit, Download, UserPlus, ArrowLeft, Tag } from "lucide-react"
...
export default function ManageStudentsPage() {
  ...
  // Mock student data with tags
  const students: Student[] = [
    {
      id: "1",
      studentId: "STU24CS001",
      name: "John Doe",
  ...
  const stats = {
    ...
    newThisYear: students.filter((s) => s.admissionYear === 2024).length,
  }
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Edit profiles and manage student tags</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <CardHeader>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <CardDescription>Search, edit profiles, and manage student tags</CardDescription>
                </div>
                <Button onClick={() => router.push("/authority/accounts/register-student")}>
