...
import { Construction, Home, ArrowLeft, RefreshCw, AlertTriangle } from "lucide-react"
...
// Known routes that are under development
const UNDER_DEVELOPMENT_ROUTES = [
  "/admin/settings",
  "/faculty/research",
  "/student/clubs",
...
export default function CatchAllPage() {
  ...
  const isUnderDevelopment = UNDER_DEVELOPMENT_ROUTES.some((route) => pathname.startsWith(route))
          ...
          <CardContent className="space-y-6">
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-4">
                We're working hard to bring you new features and improvements to the Edu-Sync ERP system.
              </p>
              <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-800">
                  <strong>Coming Soon:</strong> Enhanced functionality for this section
                </p>
              </div>
              {!loading && user && (
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-lg">
        ...
        <CardContent className="space-y-6">
          <div className="text-center">
            <p className="text-sm text-muted-foreground mb-4">
              The URL <code className="px-2 py-1 bg-gray-100 rounded text-sm">{pathname}</code> could not be found.
            </p>
            {!loading && user && (
              <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-800">
